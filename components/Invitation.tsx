...
export default function Invitation() {
  ...
  const [savedRSVPs, setSavedRSVPs] = useState<
    { name: string; count: string; attending: boolean; date: string }[]
  >([]);
        ...
        >
          <section id="hero-section" className="min-h-[calc(100dvh-4rem)]">
            <Hero
              ...
              onNext={scrollToDetails}
            />
          </section>

          <section id="event-section" className="py-6 border-t border-stone-100">
            <EventInfo
              groomName="Hamidullo"
              brideName="Muborakxon"
              dateStr="13.08.2026"
          ...
          <section id="map-section" className="px-6 py-12 flex flex-col items-center gap-8 border-t border-stone-100">
            <motion.div
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-stone-600 font-sans mt-2">Manzil: Yangi yo&apos;l shahri</p>
              </div>
              ...
              <p className="text-xs text-stone-500 font-sans leading-relaxed max-w-xs">
                Sizning qulayligingiz uchun to&apos;y o&apos;tkaziladigan maskanning aniq manzilini Google
                Xaritadan ochish imkoniyatini taqdim etamiz.
              </p>
          ...
          <section id="rsvp-section" className="px-6 py-8 flex flex-col gap-8 border-t border-stone-100">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, margin: '-40px' }}
                ...
                <div className="mt-8 border-t border-stone-200/60 pt-6">
                  ...
                  <div className="max-h-36 overflow-y-auto pr-1 space-y-2 no-scrollbar">
                    {savedRSVPs.map((rsvp, idx) => (
                      <div
                        key={idx}
                        className="flex justify-between items-center text-2xs p-2 bg-white rounded-md border border-stone-100 shadow-2xs"
                      >
            ...
            <div className="py-8 text-center flex flex-col items-center gap-3 border-t border-stone-200/40">
              ...
              <p className="text-[9px] font-sans text-stone-400 tracking-widest uppercase">
                Nikoh Tantanasi • 2026
              </p>
